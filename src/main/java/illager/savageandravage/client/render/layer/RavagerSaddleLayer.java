...
@OnlyIn(Dist.CLIENT)
public class RavagerSaddleLayer extends LayerRenderer<RavagerEntity, RavagerModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(SavageAndRavageCore.MODID, "textures/entity/friendly_ravager/friendly_ravager_saddle.png");
    private final FriendlyRavagerModel model = new FriendlyRavagerModel();

    public RavagerSaddleLayer(IEntityRenderer<RavagerEntity, RavagerModel> p_i50927_1_) {
        super(p_i50927_1_);
    }


    @Override
    public void render(RavagerEntity entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
        if (entityIn instanceof FriendlyRavagerEntity) {
