...
public class CelebrateRevampRaidVictoryTask extends Task<VillagerEntity> {
    @Nullable
    private RevampRaid raid;

    public CelebrateRevampRaidVictoryTask(int p_i50370_1_, int p_i50370_2_) {
        super(ImmutableMap.of(), p_i50370_1_, p_i50370_2_);
    }

    protected boolean shouldExecute(ServerWorld worldIn, VillagerEntity owner) {
        this.raid = SavageAndRavageCore.instance.findRaid(new BlockPos(owner));
