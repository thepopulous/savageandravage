...
public class FollowIllagerGoal extends Goal {
    ...
    public FollowIllagerGoal(MobEntity p_i47417_1_, double p_i47417_2_, float p_i47417_4_, float p_i47417_5_) {
        this.entity = p_i47417_1_;
        this.followPredicate = (p_210291_1_) -> {
            return p_210291_1_ != null && p_i47417_1_.getClass() != p_210291_1_.getClass() && (p_210291_1_ instanceof AbstractIllagerEntity);
        };
