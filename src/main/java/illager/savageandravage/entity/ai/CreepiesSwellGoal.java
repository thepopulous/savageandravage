...
public class CreepiesSwellGoal extends Goal {
    ...
    public boolean shouldExecute() {
        ...
        return this.field_75269_a.getCreeperState() > 0 || livingentity != null && this.field_75269_a.getDistanceSq(livingentity) < 2.5D;
    }
    ...
    public void tick() {
        ...
        } else if (this.field_75269_a.getDistanceSq(this.field_75268_b) > 25.0D) {
            this.field_75269_a.setCreeperState(-1);
