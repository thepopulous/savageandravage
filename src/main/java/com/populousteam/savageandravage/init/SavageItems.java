...
public class SavageItems {
    ...
    public static final Item GRIEFER_SPAWN_EGG = new SpawnEggItem(SavageEntities.GRIEFER_ILLAGER, 9804699, 0x403e43, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item POULTRY_FARMER_SPAWN_EGG = new SpawnEggItem(SavageEntities.POULTRY_FARMER, 9804699, 0x70794e, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item SAVAGELING_SPAWN_EGG = new SpawnEggItem(SavageEntities.SAVAGELING, 9804699, 9804690, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item SKELETON_VILLAGER_SPAWN_EGG = new SpawnEggItem(SavageEntities.SKELETONVILLAGER, 12698049, 4802889, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item SCAVENGER_SPAWN_EGG = new SpawnEggItem(SavageEntities.SCAVENGER, 9804699, 0xc2c0b7, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item FRIENDLY_RAVAGER_SPAWN_EGG = new SpawnEggItem(SavageEntities.FRIENDLY_RAVAGER, 12698049, 0xc2c0b7, (new Item.Properties()).group(ItemGroup.MISC));
    public static final Item HYENA_SPAWN_EGG = new SpawnEggItem(SavageEntities.HYENA, 0x4f453d, 0x64453d, (new Item.Properties()).group(ItemGroup.MISC));
    ...
    public static void register(RegistryEvent.Register<Item> registry, Item item, String id) {
        ...
        item.setRegistryName(new ResourceLocation(SavageAndRavage.MODID, id));
