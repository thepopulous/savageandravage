...
import com.populousteam.savageandravage.entity.ai.FollowPlayerAndIllagerGoal;
...
public class SavagelingEntity extends AnimalEntity implements IMob, IRaidSuppoter {
    ...
    public int timeUntilNextSneeze = 6000 + world.rand.nextInt(600);
    ...
    public SavagelingEntity createChild(AgeableEntity ageable) {
        return SavageEntities.SAVAGELING.create(this.world);
    }
