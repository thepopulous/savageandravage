...
public class DefenderEntity extends AbstractIllagerEntity {
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.348F);
    ...
    public void setGuardLevel(int level) {
        ...
        if (level == 2) {
            this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.368F);
        }
    }
    ...
    protected SoundEvent getAmbientSound() {
        if (this.isAggressive()) {
            return SavageSounds.GUARDILLAGER_ANGRY;
        } else {
            return SavageSounds.GUARDILLAGER_AMBIENT;
        }
    }

    @Override
    protected SoundEvent getDeathSound() {
        return SavageSounds.GUARDILLAGER_DIE;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SavageSounds.GUARDILLAGER_HURT;
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState blockState) {
        ...
        SoundEvent soundEvent = SavageSounds.GUARDILLAGER_STEP;
