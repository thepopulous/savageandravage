        ...
        public void tick() {
            ...
            if (blockpos != null && AbstractHouseIllagerEntity.this.navigator.noPath()) {
                if (this.func_220846_a(blockpos, 6.0D)) {
                    Vec3d vec3d = (new Vec3d((double) blockpos.getX() - this.illager.getPosX(), (double) blockpos.getY() - this.illager.getPosY(), (double) blockpos.getZ() - this.illager.getPosZ())).normalize();
                    Vec3d vec3d1 = vec3d.scale(10.0D).add(this.illager.getPosX(), this.illager.getPosY(), this.illager.getPosZ());
                    AbstractHouseIllagerEntity.this.navigator.tryMoveToXYZ(vec3d1.x, vec3d1.y, vec3d1.z, this.speed);
                } else {
                    AbstractHouseIllagerEntity.this.navigator.tryMoveToXYZ(blockpos.getX(), blockpos.getY(), blockpos.getZ(), this.speed);
                }
            }
