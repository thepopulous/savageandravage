...
import com.populousteam.savageandravage.entity.ai.RangedStrafeAttackGoal;
...
public class GrieferIllagerEntity extends AbstractIllagerEntity implements IRangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new InvadeHomeGoal(this, 1.0F, 1));
    ...
    static class InvadeHomeGoal extends Goal {
        ...
        public boolean shouldContinueExecuting() {
            if (this.field_220864_a.getNavigator().noPath()) {
                ...
                return this.field_220864_a.getAttackTarget() == null && !this.field_220866_c.withinDistance(this.field_220864_a.getPositionVec(), this.field_220864_a.getWidth() + (float) this.field_220868_e) && !this.field_220869_f;
            }
        }
        ...
        public void resetTask() {
            if (this.field_220866_c.withinDistance(this.field_220864_a.getPositionVec(), this.field_220868_e)) {
        ...
        public void startExecuting() {
            ...
            this.field_220864_a.getNavigator().tryMoveToXYZ(this.field_220866_c.getX(), this.field_220866_c.getY(), this.field_220866_c.getZ(), this.field_220865_b);
        ...
        public void tick() {
            if (this.field_220864_a.getNavigator().noPath()) {
                ...
                Vec3d vec3d = RandomPositionGenerator.findRandomTargetTowardsScaled(this.field_220864_a, 16, 7, new Vec3d(i, j, k), (float) Math.PI / 10F);
                if (vec3d == null) {
                    vec3d = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_220864_a, 8, 7, new Vec3d(i, j, k));
                }
