...
public class CropHarvestGoal extends MoveToBlockGoal {
    ...
    public void tick() {
        super.tick();
        this.illager.getLookController().setLookPosition((double) this.destinationBlock.getX() + 0.5D, this.destinationBlock.getY() + 1, (double) this.destinationBlock.getZ() + 0.5D, 10.0F, (float) this.illager.getVerticalFaceSpeed());
