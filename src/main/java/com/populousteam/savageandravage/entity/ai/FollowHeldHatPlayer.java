...
public class FollowHeldHatPlayer extends Goal {
    ...
    public FollowHeldHatPlayer(MobEntity p_i47417_1_, double p_i47417_2_, float p_i47417_4_, float p_i47417_5_) {
        this.entity = p_i47417_1_;

        this.followPredicate = (p_210291_1_) -> {
            return p_210291_1_ != null && p_i47417_1_.getClass() != p_210291_1_.getClass() && p_210291_1_ instanceof PlayerEntity;
        };
    ...
    public boolean shouldExecute() {
        List<PlayerEntity> list = this.entity.world.getEntitiesWithinAABB(PlayerEntity.class, this.entity.getBoundingBox().grow(this.areaSize), this.followPredicate);
        if (!list.isEmpty()) {
            for (PlayerEntity mobentity : list) {
                ItemStack itemstack = mobentity.inventory.armorInventory.get(3);

                if (!mobentity.isInvisible() && itemstack.getItem() == SavageItems.POULTRY_FARMER_HAT) {
