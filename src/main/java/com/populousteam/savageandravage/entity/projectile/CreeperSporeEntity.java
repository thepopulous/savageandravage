    ...
    private void spawnCreepies() {
        if (!this.world.isRemote) {
            ...
            for (int i = 0; i < 1 + this.world.rand.nextInt(2); i++) {
                CreepieEntity creepieEntity = SavageEntities.CREEPIES.create(this.world);
