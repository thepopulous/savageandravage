...
public class RevampRaid extends Raid {
        ...
        for (RevampRaid.WaveMember raid$wavemember : RevampRaid.WaveMember.VALUES) {
            ...
            for (int l = 0; l < j; ++l) {
                ...
                if (raidentity instanceof AbstractRaiderEntity) {
                    ...
                    } else if (raid$wavemember.type == SavageEntities.POULTRY_FARMER) {
    ...
    public enum WaveMember {
        ...
        DEFENDER(SavageEntities.DEFENDER, new int[]{0, 1, 1, 2, 2, 6, 3, 3, 0}),
        GRIEFER(SavageEntities.GRIEFER_ILLAGER, new int[]{0, 0, 0, 1, 2, 0, 1, 1, 2}),
        POULTRY_FARMER(SavageEntities.POULTRY_FARMER, new int[]{0, 0, 0, 0, 0, 0, 1, 1, 2}),
        HYENA(SavageEntities.HYENA, new int[]{0, 0, 0, 1, 1, 1, 0, 0, 0}),
