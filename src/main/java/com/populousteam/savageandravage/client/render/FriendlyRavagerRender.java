...
import com.populousteam.savageandravage.client.render.layer.RavagerClothLayer;
import com.populousteam.savageandravage.client.render.layer.RavagerSaddleLayer;
...
public class FriendlyRavagerRender extends MobRenderer<FriendlyRavagerEntity, FriendlyRavagerModel> {
    private static final ResourceLocation FRIENDLYRAVAGER_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/friendly_ravager/friendly_ravager_base.png");
