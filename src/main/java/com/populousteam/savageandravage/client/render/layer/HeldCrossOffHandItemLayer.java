...
import com.populousteam.savageandravage.api.IHasCrossArm;

@OnlyIn(Dist.CLIENT)
public class HeldCrossOffHandItemLayer<T extends AbstractIllagerEntity, M extends EntityModel<T> & IHasCrossArm> extends LayerRenderer<T, M> {
