...
public class HyenaRender<T extends HyenaEntity> extends MobRenderer<T, HyenaModel<T>> {
    private static final ResourceLocation HYENA_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/hyena/hyena.png");
    private static final ResourceLocation HYENA_TAMED_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/hyena/hyena_tame.png");
    private static final ResourceLocation HYENA_ANGRY_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/hyena/hyena_angry.png");
    private static final ResourceLocation HYENA_BAGU_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/hyena/hyena_bagu.png");
    private static final ResourceLocation HYENA_BAGU_TAMED_TEXTURE = new ResourceLocation(SavageAndRavage.MODID, "textures/entity/hyena/hyena_bagu_tamed.png");
