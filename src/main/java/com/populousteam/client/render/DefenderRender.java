...
import com.populousteam.client.model.DefenderModel;
import com.populousteam.client.render.layer.HeldCrossOffHandItemLayer;
...
public class DefenderRender<T extends DefenderEntity> extends MobRenderer<T, DefenderModel<T>> {
    private static final ResourceLocation ILLAGER_TEXTURE = new ResourceLocation(SavageAndRavage.MOD_ID, "textures/entity/illager/guardillager.png");
