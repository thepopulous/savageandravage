...
import com.populousteam.client.model.SkeletonVillagerModel;
...
public class SkeletonVillagerRender<T extends SkeletonVillagerEntity> extends MobRenderer<T, SkeletonVillagerModel<T>> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(SavageAndRavage.MOD_ID, "textures/entity/skeletonvillager.png");
