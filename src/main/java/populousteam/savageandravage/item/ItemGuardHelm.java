...
import populousteam.savageandravage.client.model.GuardHatModel;
...
public class ItemGuardHelm extends ArmorItem {
    protected static final ResourceLocation HAT_TEX = new ResourceLocation(SavageAndRavageCore.MODID, "textures/overlay/guard_perspective.png");
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return SavageAndRavageCore.MODID + ":textures/models/armor/guard_hat.png";
	}
