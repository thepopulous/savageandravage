...
import populousteam.savageandravage.client.model.PoultryFarmerIllagerModel;
...
public class PoultryFarmerIllagerRender<T extends PoultryFarmerIllagerEntity> extends MobRenderer<T, PoultryFarmerIllagerModel<T>> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(SavageAndRavageCore.MODID, "textures/entity/illager/poultryfarmer_illager.png");
