...
import populousteam.savageandravage.client.model.GrieferIllagerModel;
...
public class GrieferIllagerRender<T extends GrieferIllagerEntity> extends MobRenderer<T, GrieferIllagerModel<T>> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(SavageAndRavage.MOD_ID, "textures/entity/illager/grieferillager.png");
