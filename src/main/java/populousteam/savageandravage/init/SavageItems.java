...
public class SavageItems {
    ...
    public static final Item GUARD_HELM = new Item /*GuardHelmItem(SavageArmorMaterial.GUARD_HELM, EquipmentSlotType.HEAD, */ ((new Item.Properties()).group(ItemGroup.COMBAT));
