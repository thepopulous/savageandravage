...
public class ScavengersEntity extends AbstractIllagerEntity implements IRangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new UseItemOnLeftHandGoal<>(this, new ItemStack(SavageItems.SINISTER_HORN), SoundEvents.ENTITY_VINDICATOR_CELEBRATE, (p_213736_1_) -> {
